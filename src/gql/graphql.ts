...
export type CartCreateMutation = { createOrder?: { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { id: string, name: string, description: string, price: number, images: Array<{ url: string }> } | null }> } | null };
...
export type CartGetByIdQuery = { order?: { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { id: string, name: string, description: string, price: number, images: Array<{ url: string }> } | null }> } | null };

export type CartItemChangeQuantityMutationVariables = Exact<{
  itemId: Scalars['ID']['input'];
  quantity: Scalars['Int']['input'];
}>;


export type CartItemChangeQuantityMutation = { updateOrderItem?: { id: string } | null };
...
export type CategoriesGetQuery = { categories: Array<{ name: string, slug: string }> };

export type CategoryFragment = { name: string, slug: string };
...
export type CategoryGetBySlugQuery = { categories: Array<{ name: string, slug: string }> };

export type CollectionFragment = { id: string, name: string, description?: string | null, slug: string, image?: { url: string } | null };
...
export type CollectionGetBySlugQuery = { collections: Array<{ id: string, name: string, description?: string | null, slug: string, image?: { url: string } | null }> };

export type CollectionsGetQueryVariables = Exact<{ [key: string]: never; }>;


export type CollectionsGetQuery = { collections: Array<{ id: string, name: string, description?: string | null, slug: string, image?: { url: string } | null }> };

export type OrderFragment = { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { id: string, name: string, description: string, price: number, images: Array<{ url: string }> } | null }> };
...
export type OrdersGetByEmailQuery = { orders: Array<{ id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { id: string, name: string, description: string, price: number, images: Array<{ url: string }> } | null }> }> };

export type ProductDetailsFragment = { id: string, name: string, description: string, price: number, categories: Array<{ name: string, slug: string }>, images: Array<{ url: string }> };

export type ProductFragment = { id: string, name: string, price: number, averageRating?: number | null, categories: Array<{ name: string, slug: string }>, images: Array<{ url: string }> };
...
export type ProductUpdateAverageRatingMutation = { updateProduct?: { id: string } | null, publishProduct?: { id: string } | null };
...
export type ProductsGetQuery = { products: Array<{ id: string, name: string, price: number, averageRating?: number | null, categories: Array<{ name: string, slug: string }>, images: Array<{ url: string }> }> };
...
export type ProductsGetByCategorySlugQuery = { categories: Array<{ products: Array<{ id: string, name: string, price: number, averageRating?: number | null, categories: Array<{ name: string, slug: string }>, images: Array<{ url: string }> }> }> };
...
export type ProductsGetByCollectionSlugQuery = { collections: Array<{ products: Array<{ id: string, name: string, price: number, averageRating?: number | null, categories: Array<{ name: string, slug: string }>, images: Array<{ url: string }> }> }> };
...
export type ProductsGetSearchQuery = { products: Array<{ id: string, name: string, price: number, averageRating?: number | null, categories: Array<{ name: string, slug: string }>, images: Array<{ url: string }> }> };
...
export type ProductsGetSimilarQuery = { products: Array<{ id: string, name: string, price: number, averageRating?: number | null, categories: Array<{ name: string, slug: string }>, images: Array<{ url: string }> }> };
...
export type VariantsGetProductColorQuery = { productColorVariants: Array<{ color: ProductColor, product?: { id: string } | null }> };

export type VariantsGetProductSizeQueryVariables = Exact<{ [key: string]: never; }>;


export type VariantsGetProductSizeQuery = { productSizeVariants: Array<{ size: ProductSize, product?: { id: string } | null }> };
...
export const CartItemChangeQuantityDocument = new TypedDocumentString(`
    mutation CartItemChangeQuantity($itemId: ID!, $quantity: Int!) {
  updateOrderItem(where: {id: $itemId}, data: {quantity: $quantity}) {
    id
  }
}
    `) as unknown as TypedDocumentString<CartItemChangeQuantityMutation, CartItemChangeQuantityMutationVariables>;
...
export const ProductsGetDocument = new TypedDocumentString(`
    query ProductsGet($first: Int!, $skip: Int!, $orderBy: ProductOrderByInput!) {
...
export const VariantsGetProductColorDocument = new TypedDocumentString(`
  ...
  productColorVariants {
    ...
    `) as unknown as TypedDocumentString<VariantsGetProductColorQuery, VariantsGetProductColorQueryVariables>;
export const VariantsGetProductSizeDocument = new TypedDocumentString(`
  ...
  productSizeVariants {
    ...
    `) as unknown as TypedDocumentString<VariantsGetProductSizeQuery, VariantsGetProductSizeQueryVariables>;